package com.challenge.checkout.gateway.customMapping.marketX.productMapper;
...
import com.challenge.checkout.gateway.customMapping.marketX.PromotionFactoryRegistryMarketX;
...
public class ProductMapperMarketX implements ProductGatewayMapper {
                    ...
                    jsonPromotions.stream().map(
                            jsonPromotion -> {
                                ...
                                PromotionGatewayMapper promotionMapper =
                                        PromotionFactoryRegistryMarketX.getPromotionGatewayMapper(promotionType);
